...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='CSL-Daily',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='../dataset/CSL-Daily/sentence/frames_512x512',
                        help='path to the dataset')
    parser.add_argument('--target-path', type=str, default='../dataset/CSL-Daily/sentence/frames_256x256',
